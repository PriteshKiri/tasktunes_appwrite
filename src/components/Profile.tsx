      ...
      {userDetails && (
        <div className="overflow-y-auto grow p-0 color-change-5x">
          <div className="h-[100vh] relative flex flex-col justify-between items-center">
            ...
            <div className=" bg-black  opacity-60 shadow-xl p-4 px-1 sm:px-4  mb-4 sm:mb-0  flex  flex-col-reverse sm:flex-row justify-center items-center gap-6 z-50 w-[90vw]  sm:w-[70vw] h-[70%]  sm:h-[65%]  rounded-lg  ">
